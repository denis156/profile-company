            ...
            <div data-aos="fade-up" data-aos-delay="100">
                <div class="card bg-base-200 hover:bg-base-300 transition-all duration-300 p-8 group h-full">
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            <h3 class="text-2xl font-bold text-base-content break-words">Jasa Konstruksi</h3>
                            <p class="text-base-content/70 break-words">
                                Layanan konstruksi profesional dengan standar kualitas tinggi dan pengalaman
                                bertahun-tahun
                            </p>
                        </div>
                        <div
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                <div class="card bg-base-200 hover:bg-base-300 transition-all duration-300 p-8 group h-full">
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            <h3 class="text-2xl font-bold text-base-content break-words">Perdagangan Material Batuan</h3>
                            <p class="text-base-content/70 break-words">
                                Penyediaan material batuan dan kebutuhan konstruksi dengan izin resmi IPP
                            </p>
                        </div>
                        <div
                ...
                <div class="card bg-base-200 hover:bg-base-300 transition-all duration-300 p-8 group h-full">
                    <div class="space-y-6">
                        <div
                            ...
                            <x-icon name="o-chart-bar"
                                class="h-8 text-accent group-hover:text-accent-content transition-colors" />
                        </div>
                        <div class="space-y-3">
                            <h3 class="text-2xl font-bold text-base-content">Konsultan Bisnis</h3>
                            <p class="text-base-content/70">
                                Konsultasi profesional untuk pengembangan dan strategi bisnis Anda
                            </p>
                        </div>
                        <div
