<section class="py-20 bg-gradient-to-b from-base-100 to-base-200">
    <div class="container mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="text-center space-y-4 mb-16" data-aos="fade-up">
            <span class="badge badge-soft badge-accent badge-lg">Dokumentasi Kegiatan</span>
                ...
                <div class="card bg-base-100 hover:shadow-2xl transition-all duration-300 overflow-hidden group h-full">
                    <div class="aspect-[4/3] overflow-hidden relative">
                        ...
                        <div
                            ...
                            <p class="text-sm mt-1">Tim ahli kami mengoperasikan excavator untuk distribusi material
                                pasir yang efisien di kapal tongkang</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-base-100 hover:shadow-2xl transition-all duration-300 overflow-hidden group h-full">
                    <div class="aspect-[4/3] overflow-hidden relative">
                        ...
                        <div
                            ...
                            <p class="text-sm mt-1">Sistem logistik terintegrasi untuk pengiriman semen dari truck
                                menuju fasilitas penyimpanan modern</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-base-100 hover:shadow-2xl transition-all duration-300 overflow-hidden group h-full">
                    <div class="aspect-[4/3] overflow-hidden relative">
                        ...
                        <div
                            ...
                            <p class="text-sm mt-1">Transfer material semen berkualitas dari tongkang ke armada
                                transportasi dengan standar keamanan tinggi</p>
                        </div>
                    </div>
                </div>
            </div>
