<section
    class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-base-100 via-base-200 to-base-100">
    {{-- Background Pattern --}}
        ...
        <div class="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div class="space-y-6" data-aos="fade-up">
                ...
                <span class="badge badge-primary badge-soft badge-lg">
                    <div aria-label="status" class="status status-info status-md animate-pulse"></div>Segera Hadir
                </span>
                ...
                <p class="text-xl text-base-content/70 max-w-3xl mx-auto leading-relaxed break-words">
                    Ingin menghubungi kami? Tekan tombol di pojok kanan bawah untuk mengirim pesan melalui WhatsApp
                    atau Email sesuai pilihan Anda
                </p>
